...
class TestCase_1813(TestCase_Base):

    """ Sharing: Share a group """
    def _check_videos_exists(self):
        # verify test clips are all in the view
        log("Verify videos are in the view")
    ...
    def _check_photos_exists(self):
        # verify test clips are all in the view
        log("Verify photos are in the view")
        assert self.RT.does_exist_in_library(
